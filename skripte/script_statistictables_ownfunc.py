...
#ezdist+=dist
    ...
    row_ez+= "<iframe width='480' height='360' src='http://track.kit.net/maps_s3/?v=embed&track.{:.0f}.gpx' frameborder='0' allowfullscreen></iframe>\n".format(lez[key][3])
    ...
    row_ez_en+= "<iframe width='480' height='360' src='http://track.kit.net/maps_s3/?v=embed&track.{:.0f}.gpx' frameborder='0' allowfullscreen></iframe>\n".format(lez[key][3])
